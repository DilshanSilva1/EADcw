...
public class AddStudent extends javax.swing.JFrame {
   ...
   ResultSet rs = null;
    ...
    private void initComponents() {
        ...
        bloodTB = new javax.swing.JComboBox<>();
        ...
        bloodTB.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "A", "B", "AB", "O" }));
        bloodTB.setBorder(null);
        bloodTB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bloodTBActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(bloodTB, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(21, 21, 21)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        setSize(new java.awt.Dimension(889, 606));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void bloodTBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bloodTBActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_bloodTBActionPerformed
      ...
      int phonelength=phoneTB.getText().length();
       if (phonelength==10){
        try{
         ...
         String bloodType=(String)bloodTB.getSelectedItem();
         String parentName=parentTB.getText();
         String city=cityTB.getText();
         int phone=Integer.parseInt(phoneTB.getText());
         int stdClass=Integer.parseInt(classTB.getText());
         
         String sql =
                 "INSERT INTO STUDENT  (std_Name,std_FatherName,std_BloodType,std_Phone,std_City,std_Class)"
                 + " VALUES ('"+stdName+"','"+parentName+"','"+bloodType+"','"+phone+"','"+city+"','"+stdClass+"')";
    ...
    private javax.swing.JComboBox<String> bloodTB;
